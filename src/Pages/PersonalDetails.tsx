                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="grid gap-2">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="lg:text-base">NIN</FormLabel>
                          <FormControl>
                            <Input
                  ...
                  <div className="grid gap-2">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="lg:text-base">Gender</FormLabel>
                          <FormControl>
                            <Input
                  ...
                  <div className="grid gap-2">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="lg:text-base">LGA</FormLabel>
                          <FormControl>
                            <Input
                  ...
                  <div className="grid gap-2">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="lg:text-base">Town</FormLabel>
                          <FormControl>
                            <Input
